This repository is a fork of the original one with some tweaks to ensure its functionality, the newest compiled version of the plugin is in the Releases.
